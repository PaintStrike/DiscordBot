...
############################ Comandos de musica ###########################
    ...
    if msg.content.startswith("!play"):
        ...
        urllen = len(url)
        if urllen > 45:
              await msg.channel.send('¡Pansito solo acepta links de Youtube! Por Favor asegurate que si es de youtube, no estes compartiendo un link de una playlist.')
        else:
          try:
...
############################ Momos ###########################################
    ...
    if msg.content.startswith('!VirgenAnger'):
